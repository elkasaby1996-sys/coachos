...
export function PtHubClientTable({
  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-border/70 bg-background/20">
      <div className="hidden grid-cols-[minmax(0,1.2fr)_180px_220px_160px] gap-4 border-b border-border/60 px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground lg:grid">
        <span>Client</span>
        <span>Workspace</span>
        <span>Lifecycle</span>
      ...
      <div className="divide-y divide-border/60">
        {clients.map((client) => {
          ...
          return (
            <div
              key={client.id}
              className="grid gap-4 px-5 py-4 lg:grid-cols-[minmax(0,1.2fr)_180px_220px_160px] lg:items-center"
            >
