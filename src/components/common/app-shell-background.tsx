  ...
  return (
    <div className="pointer-events-none absolute inset-0 -z-20 overflow-hidden" aria-hidden="true">
      <div
        ...
        style={{
          background: isLightMode
            ? "linear-gradient(180deg, rgba(239, 244, 248, 0.94), rgba(229, 236, 242, 0.92) 44%, rgba(218, 228, 235, 0.96))"
            : "linear-gradient(180deg, rgba(10, 15, 22, 0.92), rgba(9, 14, 20, 0.94) 42%, rgba(7, 10, 16, 0.98))",
        }}
      />
      <div
      ...
      <div
        ...
        style={{
          background: isLightMode
            ? "linear-gradient(180deg, rgba(255,255,255,0.09), transparent 18%, transparent 84%, rgba(15,23,42,0.05))"
            : "linear-gradient(180deg, rgba(255,255,255,0.025), transparent 18%, transparent 82%, rgba(0,0,0,0.24))",
        }}
      />
    </div>
  );
    ...
    <>
      ...
      <div
        ...
        style={{
          background:
            mode === "light"
              ? "linear-gradient(180deg, rgba(255,255,255,0.06), rgba(255,255,255,0), rgba(15,23,42,0.03))"
              : "linear-gradient(180deg,rgba(8,12,18,0.12),rgba(7,10,16,0.28))",
        }}
        aria-hidden="true"
      />
    </>
