...
export function SettingsPageShell({
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card/70">{children}</div>
    </section>
  );
}
...
export function SettingsBlock({
  ...
  return (
    <div className={cn("space-y-5 px-5 py-5 md:px-6", !noBorder && "border-b border-border")}> 
...
export function SettingsToast({
  ...
  return (
    <div className="fixed right-6 top-6 z-50 w-[280px]">
      <Alert className={variant === "error" ? "border-danger/30" : "border-emerald-200"}>
