-- PR-05.1: During beta, client continuity wins over destructive lead transfer.
-- Keep normal first-time lead approval/re-add behavior, but block transfer paths
-- that previously reset workspace-related client data by deleting client rows.
